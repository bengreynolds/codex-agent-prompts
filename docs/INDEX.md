...
- `docs/STRUCTURE.md` - Directory layout and naming conventions.
- `docs/STYLE_GUIDE.md` - Markdown and prompt writing standards.
- `CONTRIBUTING.md` - How to add and maintain prompts.
...
- `prompts/workflows/create-codebase-context-lite.md` - Gather task-scoped context with minimal token use.
